...
<section class="services_inner_page section section-fullheight section-projects section-projects-slider bg-light-3 text-center overflow"
    ...
    <div class="grey-bg section-fullheight__inner section-fullheight__inner_mobile">
        <div class="slider slider-fullscreen-projects js-slider-fullscreen-projects js-slider d-flex justify-content-center big_border_circle">
            <!-- slider IMAGES -->
        ...
        <!-- - slider FOOTER -->
        <div class="short_description animheadertext-2 anim-para-text container text-center mb-md-5">
            <p class="js-split-p-letter color_white">
                {{$short_description2}}
            </p>
        </div>
